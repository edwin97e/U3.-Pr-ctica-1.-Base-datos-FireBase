...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lista;
        List<Producto> datosConsultarProducto;
    ...
    private void insertarProducto(){
        Producto producto = new Producto(nombre.getText().toString(), descripcion.getText().toString(), cantidad.getText().toString(), fecha.getText().toString());
    ...
    private void crearListView(){
        ...
        for(int i = 0; i<nombres.length;i++){
            Producto j = datosConsultaProducto.get(i);
